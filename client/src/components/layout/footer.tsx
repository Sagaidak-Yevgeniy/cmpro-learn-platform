    ...
    <footer className="bg-white mt-12">
      <div className="max-w-7xl mx-auto py-8 px-4 overflow-hidden sm:px-6 lg:px-8">
        ...
        <div className="mt-8 flex justify-center space-x-6">
          ...
          <a href="https://www.instagram.com/code_masterspro/" className="text-gray-400 hover:text-gray-500">
          ...
          <a href="https://github.com/Sagaidak-Yevgeniy/" className="text-gray-400 hover:text-gray-500">
